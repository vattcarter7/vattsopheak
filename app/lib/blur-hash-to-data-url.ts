// This file is not needed in production, so `blurhash` library should be installed in the devDependencies
// Code: https://gist.github.com/mattiaz9/53cb67040fa135cb395b1d015a200aff
...
// Note: run the command `ts-node app/lib/blur-hash-to-data-url.ts`
const result = blurHashToDataURL("LJKu~TO+ALsl5xNeoIR*yDg2I:nk");
console.log({ result });
